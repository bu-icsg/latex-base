...
\titlegraphic{\includegraphics[width=0.20\textwidth]{build/boston_univ_cmyk.eps}}

\begin{document}
\maketitle

%% BU logo placement on all slides in the bottom right corner.
%% This limits the available space for text and images on the slides.
%% If you're using this, disable the logo in header-presentation.
%%
%% \logo{\includegraphics[width=0.75in]{build/boston_univ_cmyk.eps}}
